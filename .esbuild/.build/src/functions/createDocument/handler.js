...
// src/functions/createDocument/handler.ts
__export(exports, {
  main: () => main
});
...
var hello = async (event) => {
  ...
  await dynamo.put({
    ...
    Item: __spreadProps(__spreadValues({}, event.body), { id: randomString(100, "abcdefghigjklmnopqrstuvwxyzAbcdefgh12364839847#$^&(*(&%$#`") })
  }).promise();
